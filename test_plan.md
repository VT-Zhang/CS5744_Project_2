...
The EDNA application is a complicated system empassing a number of separated subsystems, including:
...
Given the characteristics and architectural design of the EDNA application, our team proposes to conduct 4-phase integration testing for the target system. The diagram of the testing plan is showing as below:

![Test_Plan_Diagram](https://user-images.githubusercontent.com/24898162/101113472-73012000-35ad-11eb-8549-3f62a28c9a5e.png)
